...
public class Cunsumer_Test {
	...
	public RequestResponsePact createPact(PactDslWithProvider buider) {
		...
		DslPart requestAndRespnse= new PactDslJsonBody().
				numberType("id",999).
				stringType("firstName","MANI").
				stringType("LastName","KH").
				stringType("Email","Mani.KH@gamil.com");
			//create contract
	...
	public void postRequestTest() {
		...
		request.put("id", "123");
		request.put("firstName", "Main");
		request.put("LastName", "KH");
		request.put("Email", "Mani.KH@gamil.com");
